    ...
    (parser
     ...
     (grammar
      ...
      (new-struct-type ((unpacked-struct-type) $1)
                       ((PACKED unpacked-struct-type) (begin (set-packable-type-packed?! $2 #t) $2)))
      ...
      (proc-decl ((proc-heading SC id) (list 'proc $1 $3))
      ...
      (var-parameter-spec ((VAR id-list COLON id) (list 'var $2 $4)))
      ...
      (packed-conf-array-schema ((PACKED ARRAY LB index-type-spec RB OF id) (list 'packed $4 $7)))
      ...
      (index-type-spec ((id DDOT id COLON id) (list 'index $1 $3 $5)))
