  ...
  (define (spc-parser source)
    (parser
     ...
     (grammar
      ...
      (compound-statement ((BEGIN statement-sequence END) $2))
      (cond-statement ((if-statement) $1)
                      ((case-statement) $1))
      (if-statement ((IF expr THEN statement) (make-if-statement $2 $4 null))
                    ((IF expr THEN statement ELSE statement) (make-if-statement $2 $4 $6)))
      (case-statement ((CASE expr OF case-list-element-list END) (make-case-statement $2 $4))
                      ((CASE expr OF case-list-element-list SC END) (make-case-statement $2 $4)))
      (case-list-element-list 
       ((case-list-element) (list $1))
       ((case-list-element-list SC case-list-element) (cons $3 $1)))
      (case-list-element ((const-list COLON statement) (make-case-element $1 $3)))
      (repetitive-statement ((repeat-statement) $1)
                            ((while-statement) $1)
                            ((for-statement) $1))
      (repeat-statement ((REPEAT statement-sequence UNTIL expr) (make-repeat-statement $2 $4)))
      (while-statement ((WHILE expr DO statement) (make-while-statement $2 $4)))
      (for-statement ((FOR id ASSIGN expr to-downto expr DO statement) (make-for-statement $2 $4 $5 $6 $8)))
      (to-downto ((TO) 'to)
                 ((DOWNTO) 'downto))
      (with-statement ((WITH record-var-list DO statement) (make-with-statement $2 $4)))
      (record-var-list ((var-access) (list $1))
                       ((var-access COMMA record-var-list) (cons $1 $3)))
      (statement ((labeled simple-statement) (if (null? $1) 
                                                 $2
                                                 (make-labeled-statement $1 $2)))
                 ((labeled struct-statement) (if (null? $1) 
                                                 $2 
                                                 (make-labeled-statement $1 $2))))
      (labeled (() null)
               ((int COLON) $1))
